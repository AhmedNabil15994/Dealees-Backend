...
use Modules\Catalog\Http\Requests\FrontEnd\RateProductRequest;
...
class CatalogController extends WebServiceController
{
    ...
    public function getHomeData(Request $request)
    {
        ...
        return $this->response(HomeResource::collection($home_sections));
    }
    ...
    public function rateProduct(RateProductRequest $request,$id)
    {
        $product = $this->catalog->rateProduct($request, $id);
        if ($product) {
            return $this->response(null,'Rated Successfully !!');
        } else
            return $this->response(null);
    }
}
